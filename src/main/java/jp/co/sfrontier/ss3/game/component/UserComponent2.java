package jp.co.sfrontier.ss3.game.component;
...
import jp.co.sfrontier.ss3.game.repository.UserInformationDao;
import jp.co.sfrontier.ss3.game.repository.UserInformationDaoImpl;

/**
 * ユーザ情報に関連する処理を担当するクラス
 */
public class UserComponent2 {
	private static final Logger logger = LogManager.getLogger(UserComponent2.class);
