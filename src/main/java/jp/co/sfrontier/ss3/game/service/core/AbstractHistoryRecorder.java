...
public abstract class AbstractHistoryRecorder<T extends GameAction, R extends GameResult>
	 ...
	 * 対戦履歴を保存する
	 */
	private void saveHistory(Player<T> player, int opponentUserId, ResultCode resultCode,
	 ...
	 * 対戦履歴を作成する
	 */
	private ResultHistory createHistory(Player<T> player, int opponentUserId, ResultCode resultCode,
			LocalDateTime targetDate) {
