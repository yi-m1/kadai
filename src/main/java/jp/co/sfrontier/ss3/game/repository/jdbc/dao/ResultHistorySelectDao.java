package jp.co.sfrontier.ss3.game.repository.jdbc.dao;
...
import jp.co.sfrontier.ss3.game.dto.history.ResultHistoryResponse;

/**
 * 履歴周りのデータベース処理をまとめたクラス
 */
public class ResultHistorySelectDao {

	private Connection connection;

	public ResultHistorySelectDao(Connection connection) {
	 ...
	 * @throws SQLException
	 */
	public List<ResultHistoryResponse> getResultHistoryInfo(int userId) throws SQLException {

		String sql;
		PreparedStatement pstmt;

		// 取得した対戦履歴をリストに格納するため用意
		List<ResultHistoryResponse> resuhisList = new ArrayList<ResultHistoryResponse>();
		...
		while (rset.next()) {
			// オブジェクトにデータを一時格納
			ResultHistoryResponse resuhisInfo = new ResultHistoryResponse();
